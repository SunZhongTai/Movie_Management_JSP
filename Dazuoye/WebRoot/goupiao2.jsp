      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><a href="goupiao2.jsp"><i class="icon-dashboard"></i>电影类型</a></li>
              <li class="active"><i class="icon-file-alt"></i>爱情片</li>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<p style="text-align:left;">正在热映爱情类电影</p>
	<hr>	
	...
	<article class="card mb-5 ml-5 mr-3 card-outline-info">
	  	...
	  	<article class="card mb-5 ml-3 mr-3 card-outline-info">
			<img class="img-fluid" src="images/in10.jpg">
			<div class="card-block">
				<h4 class="card-title">请以你的名字呼唤我</h4>
			</div>
				<input type="button" value="点此购票" onclick="window.location.href='goupiaojilu2.jsp?moviename=22'">
	  </article>	  
	  	<article class="card mb-5 ml-auto mr-5 card-outline-info">
			<img class="img-fluid" src="images/in8.jpg">
			<div class="card-block">
				<h4 class="card-title">怦然心动</h4>
			</div>
				<input type="button" value="点此购票" onclick="window.location.href='goupiaojilu2.jsp?moviename=23'">
	  </article>
</div>
