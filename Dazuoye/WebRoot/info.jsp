    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <li class="ffont"><a href="goupiaojilushow.jsp">购票管理</a></li>
            <li class="ffont active"><a href="info.jsp">个人信息</a></li>
      ...
      <div id="page-wrapper">
          ...
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><a href="info.jsp"><i class="icon-dashboard"></i>个人信息</a></li>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <li style="text-align:right">欢迎<%=username%>用户登录在线电影票售卖系统</li>
		...
		<!-- 
		<%
		String fileurl="readme.txt";
		%>
		<div>
	<form method="post"  action="http://localhost:8080/Dazuoye/downloadServlet" enctype="multipart/form-data">
		<input type="hidden" name="fileurl" value="<%=fileurl%>">
		<input class="btn btn-primary" type="submit" value="下载附件">
	</form>
	</div>
	 -->
