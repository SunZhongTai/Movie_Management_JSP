      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><a href="goupiao1.jsp"><i class="icon-dashboard"></i>电影类型</a></li>
              <li class="active"><i class="icon-file-alt"></i>动作片</li>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<p style="text-align:left;">正在热映动作类电影</p>
	<hr>	
	<div class="row text-center card-deck mt-3">
	  ...
	  <article class="card mb-5 ml-5 mr-3 card-outline-info">
	  	...
	  	<article class="card mb-5 ml-3 mr-3 card-outline-info">
			<img class="img-fluid" src="images/in6.jpg">
			<div class="card-block">
				<h4 class="card-title">复仇者联盟3</h4> 
			</div>
				<input type="button" value="点此购票" onclick="window.location.href='goupiaojilu1.jsp?moviename=12'">
	  </article>	  
	  	<article class="card mb-5 ml-auto mr-5 card-outline-info">
			<img class="img-fluid" src="images/in7.jpg">
			<div class="card-block">
				<h4 class="card-title">侏罗纪世界2</h4>
			</div>
				<input type="button" value="点此购票" onclick="window.location.href='goupiaojilu1.jsp?moviename=13'">
	  </article>
</div>
